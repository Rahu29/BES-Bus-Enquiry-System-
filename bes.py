...
bg_image=ImageTk.PhotoImage(Image.open("F:/python/minor project/b.jfif"))
bg_image2=ImageTk.PhotoImage(Image.open("F:/python/minor project/a.jfif"))
background_image=ImageTk.PhotoImage(Image.open("F:/python/minor project/d.jfif"))
